...
As for the speaking sound, I was not able to find anything online that I could use. I donwloaded ![Ardour](https://ardour.org/), a free and open-source DAW, and recorded myself making a very short 'huh' sound. This can be passed to the NPCs alongside a pitch value, which allows the NPCs to not all sound the same.
